...
print(" \033[92;1m Connect WhatsApp  ")

os.system("xdg-open https://wa.me/+8801957550919")
...
def admin():
	...
	if bal =='2':
		...
		os.system('xdg-open https://www.facebook.com/jahid.ahmad54768?mibextid=ZbWKwL');time.sleep(1)

		admin()

	if bal =='3':

		os.system('xdg-open https://github.com/jahid-gst');time.sleep(1)
...
def a(uid,pwx,tl):
    ...
    'cookie': 'datr=Ud8IZNjADyuI0U6VzsK9eBi1; sb=Ud8IZJKTnuX-CLlOFyJIsVyE; fr=0mz7jUFJBTc7RuKg5..BkCN9R.6o.AAA.0.0.BkCN9Z.AWUdNbMRb30',
